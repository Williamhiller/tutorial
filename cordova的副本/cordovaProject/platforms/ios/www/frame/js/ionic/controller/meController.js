...
/** 我的页面 **/
.controller("MeCtrl",["$scope","commonService","commonRemoteService","validateService","$ionicScrollDelegate",function(scope,commonService,commonRemoteService,validateService,$ionicScrollDelegate){
    scope.data = {};
