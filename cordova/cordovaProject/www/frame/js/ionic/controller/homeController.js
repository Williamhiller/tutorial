...
angular.module('home.controller', [])
    .controller('HomeCtrl',['$scope','commonRemoteService','$rootScope','validateService','commonService','safeApply',"RepaymentUtilInit",function(scope,commonRemoteService,$rootScope,validateService,commonService,safeApply,RepaymentUtilInit){
        scope.data={};
        // 轮播图
