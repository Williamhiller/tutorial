...
angular.module('starter', ['ionic','ngCordova','global','ngCookies','ionic-native-transitions'])
    .run(["$rootScope","$state",'$location','$ionicPlatform','$window','$ionicLoading','$ionicViewSwitcher','$ionicHistory','$timeout',"commonRemoteService","$stateParams","commonService",function($rootScope,$state,$location,$ionicPlatform,$window,$ionicLoading,$ionicViewSwitcher,$ionicHistory,$timeout,commonRemoteService,$stateParams,commonService){
        "use strict";
        $rootScope.domain = "http://nanxiangzichan.com/fxwechat/"
